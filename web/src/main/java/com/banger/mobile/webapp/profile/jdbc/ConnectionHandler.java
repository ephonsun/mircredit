package com.banger.mobile.webapp.profile.jdbc;
...
public final class ConnectionHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (traceMethods.contains(methodName)) {
            ...
            TimeProfiler.addTrace(new StringBuilder(methodName).append(": ").append(sql.trim())
                .toString());
        ...
        if (methodName.equals(statementMethod)) {
            ...
            return Proxy.newProxyInstance(Statement.class.getClassLoader(), parameter,
