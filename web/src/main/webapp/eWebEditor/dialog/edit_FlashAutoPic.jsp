...
<title></title>
	...
	<script>
	   ...
	   if(p0=="")
		...
		else
		{
		   ...
		   var label="{$FlashAutoPic_"+p0+"_"+p1+"_"+p2+"_"+p3+"_"+p4+"_"+p5+"_"+p6+"}";  
		  // alert(label);
	...
	<form name="form1" method="post" action="" >
	  <table width="667" border="0" align="center">
        <tr>
          <td width="284" height="480"><iframe ID='ColumnTree'  src="lookleftNewsColumn.action" frameborder='1' scrolling='yes' width='100%' height='100%'>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
          </iframe></td>
          <td width="383" valign="top" height="480"><fieldset style="height:480">
            <legend><strong>Flash图片列表滚动显示</strong></legend>
            <table width="383" height="69%">
              <tr class='tdbg'>
                <td width="41%" align="right"><span class="STYLE1">&nbsp;图片显示张数：</span></td>
                <td align="left" width="59%">&nbsp;
                    <input name="P1" type="text" id="P1" value="$p1" maxlength="5"></td>
              </tr>
              <tr class='tdbg'>
                <td align="right"><span class="STYLE1">&nbsp;图片宽度：</span></td>
                <td align="left">&nbsp;
                    <input name="P2" type="text" id="P2" value="$p2" maxlength="5"></td>
              </tr>
              <tr class='tdbg'>
                <td align="right"><span class="STYLE1">&nbsp;图片高度：</span></td>
                <td align="left">&nbsp;
                    <input name="P3" type="text" id="P3" value="$p3" maxlength="5"></td>
              </tr>
              <tr class='tdbg'>
                <td align="right"><span class="STYLE1">显示文字高度：</span></td>
                <td align="left">&nbsp;
                    <input name="P4" type="text" id="P4" value="$p4" maxlength="5"></td>
              </tr>
              <tr class='tdbg'>
                <td align="right"><span class="STYLE1">文字字数：</span></td>
                <td align="left">&nbsp;
                    <input name="P5" type="text" id="P5" value="$p5" maxlength="5"></td>
              </tr>
              <tr class='tdbg'>
                <td align="right"><span class="STYLE1">取值范围：</span></td>
                <td align="left">&nbsp;
                    <select name="P6" id="P6">
                      <option value="0" selected="selected">本级栏目图片</option>
                      <option value="1">本级栏目及子栏目图片</option>
                    </select>
                    <script language="javascript">document.form1.P6.value = "$p6";</script>
                </td>
              </tr>
              <tr >
                <td height="70" colspan="2" align="center" valign="middle"><input type="button" name="Submit" value="提交" onClick="InsertLabel()">
                  &nbsp;
        ...
        <tr>
          <td colspan="2" align="left" style="padding-left:10px;"><fieldset>
