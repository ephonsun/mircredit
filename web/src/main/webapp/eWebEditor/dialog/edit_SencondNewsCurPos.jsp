...
<title></title>
	...
	<form name="form1" method="post" action="" >
	  <table width="" border="0" align="center">
        ...
        <tr>
		  <td><strong>二级网站栏目当前位置</strong></td>
          <td ><iframe ID='ColumnTree'  src="lookleftNewsColumn.action" frameborder='1' scrolling='yes' width='250' height='300'>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
          </iframe>		  </td>
        </tr>
