...
(function () {
    ...
    */
     ...
     */
    /*update by wuxj ie6下无法正确自动获取路径*/
    var ie6=!-[1,]&&!window.XMLHttpRequest;
    //调用项目main页面getUrl方法获取层级目录路径，主要解决ie6的was环境下路径不正确问题
    var urlFlag =window.top.getUrl();
    if(ie6){
        var URL = window.UEDITOR_HOME_URL || urlFlag + '/js/ueditor/';
    }else{
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        //,imageUrl: urlStr+"/imageUpload"             //图片上传提交地址
        ,imagePath: "../showImage?fullPath="       //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //图片在线管理配置区
        //,imageManagerUrl: urlStr+"/imageManager"       //图片在线管理的处理地址
        //,imageManagerPath: urlStr+"/showImage?fullPath="                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['undo', 'redo', '|',
                ...
                'blockquote', '|', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','selectall', 'cleardoc', '|','rowspacingtop', 'rowspacingbottom','lineheight', 'indent', '|' ,'directionalityltr', 'directionalityrtl', '|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|','touppercase','tolowercase','|',
                'fontfamily', 'fontsize', '|','link', 'unlink', '|', 'insertimage','template', '|','horizontal', 'date', 'time', 'spechars', 'wordimage', '|',
                'inserttable', 'deletetable','|','preview', 'searchreplace']
        ]
