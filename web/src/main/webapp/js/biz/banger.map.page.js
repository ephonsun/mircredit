...
var pageType=1; //1为显示客户分页组件/2为显示用户分页组件
function pageLoad(){  //obj为显示客户或者用户模块名
    objPage=$("#customerResult tr");
    j=objPage.length;
...
function upPage(p){
    ...
    document.getElementById("page-customer").innerHTML=strS+strC+strE+strE2 ;
}