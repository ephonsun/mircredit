 ...
 * 合同 主表 卡贷宝
 */
public class ContCardMain extends BaseLnContract implements Serializable {
    ...
    private String yearRateType;//年利率方式
    private String yearRate;//年利率



    public ContCardMain(LnLoanInfo lnLoanInfo, List<LnRepaymentPlan> repaymentPlans) {
        ...
        if(null!=lnLoanInfo){
            ...
            this.setYearRate(lnLoanInfo.getResultRate());//年利率
        }
    ...
    public String getYearRateType() {
        return yearRateType;
    }

    public void setYearRateType(String yearRateType) {
        this.yearRateType = yearRateType;
    }
