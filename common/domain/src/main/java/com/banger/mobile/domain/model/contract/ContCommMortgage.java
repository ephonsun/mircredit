 ...
 * 担保主表
 */
public class ContCommMortgage extends BaseLnContract implements Serializable {
...
//    private String creditNo ;//统一社会信用代码
    ...
    private String mortgageBeginTime;//抵押时间.开始
    private String mortgageEndTime;//抵押时间.结束
    ...
    public ContCommMortgage(){

    }
    public ContCommMortgage(LnLoanInfo lnLoanInfo,	List<LnPledge> lnPledgeList) {
...
//    }
    ...
    public String getMortgageBeginTime() {
        return mortgageBeginTime;
    }

    public void setMortgageBeginTime(String mortgageBeginTime) {
