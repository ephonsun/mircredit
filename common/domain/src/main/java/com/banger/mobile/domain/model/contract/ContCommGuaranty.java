 ...
 * 担保主表
 */
public class ContCommGuaranty extends BaseLnContract implements Serializable {
...
//    private String creditNo;//贷款人 统一社会信用代码
    ...
    public ContCommGuaranty(){

    }
    public ContCommGuaranty(LnLoanInfo lnLoanInfo,List<LnLoanGuarantorBean> loanGuarantorList) {
