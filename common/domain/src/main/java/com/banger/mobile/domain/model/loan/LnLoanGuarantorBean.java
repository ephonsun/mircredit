...
/**
 * @author QianJie
 * @version $Id: LnLoanGuarantorBean.java,v 0.1 Feb 19, 2013 4:08:30 PM QianJie Exp $
 */
public class LnLoanGuarantorBean extends BaseLnLoanGuarantor {

    private static final long serialVersionUID = -2741920647009659615L;
    ...
    private Integer belongUserId;                          //归属用户id
