...
/**
 * @author QianJie
 * @version $Id: BaseCrmCustomerExtField.java,v 0.1 May 28, 2012 4:26:42 PM QianJie Exp $
 */
public class BaseCrmCustomerExtField extends BaseObject implements Serializable {

    private static final long serialVersionUID = -7888233356658543446L;
    ...
    public BaseCrmCustomerExtField() {
        super();
    }
    
    public BaseCrmCustomerExtField(Integer extFieldId, Integer customerId, Date extDate01, Date extDate02,
    ...
    public boolean equals(Object object) {
        if (!(object instanceof BaseCrmCustomerExtField)) {
            return false;
        }
        BaseCrmCustomerExtField rhs = (BaseCrmCustomerExtField) object;
        return new EqualsBuilder().appendSuper(super.equals(object)).append(this.extFloat16,
            ...
            .append(this.extString15, rhs.extString15).append(this.extLongString07,
                ...
                rhs.extDate13).append(this.customerId, rhs.customerId).append(this.extDate15,
    ...
    public int hashCode() {
        return new HashCodeBuilder(-1451891519, 1219946697).appendSuper(super.hashCode()).append(
            ...
            .append(this.extDate08).append(this.extString22).append(this.extString44).append(
                ...
                this.extDate13).append(this.customerId).append(this.extDate15).append(
    ...
    public String toString() {
        return new ToStringBuilder(this).append("extString14", this.extString14).append(
            ...
            "extFloat08", this.extFloat08).append("customerId", this.customerId).append(
