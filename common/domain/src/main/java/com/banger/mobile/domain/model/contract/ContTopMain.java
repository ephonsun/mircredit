 ...
 * 合同 主表   最高额
 */
public class ContTopMain extends BaseLnContract implements Serializable {
    ...
    public ContTopMain(LnLoanInfo lnLoanInfo, List<LnRepaymentPlan> repaymentPlans) {
        ...
        if(null!=lnLoanInfo){
            ...
            this.setGuarantyType(lnLoanInfo.getAppGuarantorWayId());//担保方式
