 ...
 */
public class CustomerImportBar extends BaseObject implements Serializable {
	 private Integer totalAmout;       //总数
	     ...
	     * @param isStop
	     */
	    public CustomerImportBar(Integer totalAmout, Integer cuurRow, Integer isRun, Integer isStop) {
	        super();
	    ...
	    public boolean equals(Object object) {
	        if (!(object instanceof CustomerImportBar)) {
	            return false;
	        }
	        CustomerImportBar rhs = (CustomerImportBar) object;
