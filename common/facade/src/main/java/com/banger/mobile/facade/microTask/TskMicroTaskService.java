...
/**
 * @author QianJie
 * @version $Id: TskMicroTaskService.java,v 0.1 Mar 2, 2013 11:47:22 AM QianJie Exp $
 */
public interface TskMicroTaskService {
    ...
    public PageUtil<TskMicroTask> getMyTaskListPage(Map<String, Object> conds, Page page);
