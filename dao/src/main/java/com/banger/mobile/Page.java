...
public class Page implements Serializable {
    ...
    public void setCurrentPage(int i) {
    	currentPage = (totalPages>0 && (i>totalPages || i==0))?totalPages:i;        //检查零境值
        ...
        if (currentPage * pageSize < totalRowsAmount) {
            ...
            if (pageEndRow <= 0) {// 修改了当totalRowsAmount =0,currentPage=1 的错误
                pageStartRow = currentPage * pageSize;;// 计算当前页码起始的位置
            }
        }
